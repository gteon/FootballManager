        ...
        <div className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Match server-authoritative, simulation côté serveur, streaming WebSocket.
            </p>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card className="overflow-hidden">
            <CardHeader>
              ...
              <CardDescription>
                Terrain + rendu live piloté par les snapshots.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="rounded-lg border bg-muted/30 p-3">
                <div className="text-xs text-muted-foreground">
                  Debug view (prochain: interpolation + joueurs)
                </div>
                <div className="mt-2 flex items-center justify-between">
                  <div className="text-xs text-muted-foreground">Ball</div>
                  <div className="font-mono text-xs">
                    {snapshot
                      ? `(${snapshot.ball.x.toFixed(1)}, ${snapshot.ball.y.toFixed(
                          1,
                        )}, z=${snapshot.ball.z.toFixed(1)})`
                      : '–'}
                  </div>
                </div>
              </div>
