...
import { Role, State, DECISION_INTERVAL, PLAYER_RADIUS, PITCH_W, PITCH_H, BALL_RADIUS, GOAL_W, FRICTION, GRAVITY, BOUNCE_DAMP } from './constants';
...
export class Player {
  ...
  public receivingTarget: Vec2 | null;
  public stateTimer: number;
  public clearanceCooldown: number;
